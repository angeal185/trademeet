...
const xdata = Object.assign({
  default:{
    ...
    csp: "default-src 'self';img-src *;object-src 'none';frame-src 'none';block-all-mixed-content;upgrade-insecure-requests;connect-src http://localhost:8000 https://raw.githubusercontent.com/wiki/angeal185/trademeet/ "+ hub_base +"/ "+ github_api,
    meta: [{
      name: 'viewport',
